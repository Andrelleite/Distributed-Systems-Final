   ...
   <form  action="returntomain" method="post" >
	...
	<c:choose>
		<c:when test="${session.certificate == session.password}">
			<form class="form-inline my-2 my-lg-0" action="indexurl" method="post">
      			<input class="form-control mr-sm-2" type="search" placeholder="url for indexation" aria-label="Search"  name="index">
      			<input type="submit" value="Search" class="btn btn-outline-success my-2 my-sm-0">
    		</form>
		</c:when>
		<c:otherwise>
		<div class="centro">
   			 <form class="form-inline" action="indexurl" method="post" >
