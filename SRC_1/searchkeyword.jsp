...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
   ...
   <form class="form-inline my-2 my-lg-0" action="searchkey" method="post">
      <input class="form-control mr-sm-2" type="search" placeholder="Keyword for search" aria-label="Search"  name="url">
